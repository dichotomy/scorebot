...
"""
    ...
    Little modifications by Georgi Kolev:
     ...
     Dec 18, 2011
     -----------------
     Objectified by Dichotomy <dichotomy@riseup.net>
...
if __name__ == '__main__':
   my_ping = Ping()
   my_ping.verbose_ping("google.com")
   result = my_ping.quiet_ping("google.com")
   print result
   my_ping.verbose_ping("a-test-url-taht-is-not-available.com")
