...
."AND tickets.category_id = categories.id AND tickets.state_id = states.id AND tickets.assigned_uid = '$current_user_id' AND tickets.state_id = '1' ORDER BY tickets.id DESC";
